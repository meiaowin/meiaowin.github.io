...
<![CDATA[function time() {
    timer = setTimeout(function() {
        window.location.href = FR.cjkEncode("/WebReport/ReportServer?formlet=doc/JS/表单JS实例/01-JS实现暂停和继续轮播frm报表2.frm"); //要轮播的报表url
    }, 2000); //轮播间隔
}
...
<TemplateID TemplateID="14b5f5f8-04a8-459e-a703-d6e47b19e264"/>
