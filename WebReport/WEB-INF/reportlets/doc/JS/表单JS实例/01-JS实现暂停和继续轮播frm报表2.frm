...
<![CDATA[function time() {
    timer = setTimeout(function() {
        window.location.href = FR.cjkEncode("/WebReport/ReportServer?formlet=doc/JS/表单JS实例/01-JS实现暂停和继续轮播frm报表1.frm"); //要轮播的报表url
    }, 2000); //轮播间隔
}
...
<TemplateID TemplateID="bcd53310-fed3-4e16-9f82-30fc24c53d75"/>
