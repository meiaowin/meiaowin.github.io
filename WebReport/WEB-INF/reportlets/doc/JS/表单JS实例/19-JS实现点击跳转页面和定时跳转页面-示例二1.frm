...
<Parameters/>
<Content>
<![CDATA[window.location = FR.cjkEncode("${servletURL}?formlet=doc/JS/表单JS实例/19-JS实现点击跳转页面和定时跳转页面-示例二2.frm");]]></Content>
</JavaScript>
</Listener>
...
<TemplateID TemplateID="2820447c-6cab-4a66-812b-1fb314224fc6"/>
